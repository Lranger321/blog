...
public class UserService {
    ...
    public StatisticsResponse getAllStat(){
        ...
        statisticsResponse.setPostCount(postRepository.count());
        statisticsResponse.setViewCount(postRepository.countViews());
        statisticsResponse.setLikesCount(votesRepository.countAllByValue(true));
        statisticsResponse.setDislikeCount(votesRepository.countAllByValue(false));
        statisticsResponse.setFirstPublication(postRepository.getFirstPost().getTime());
        return statisticsResponse;
    }

    public StatisticsResponse getStatForUser(String email){
        StatisticsResponse statisticsResponse = new StatisticsResponse();
        statisticsResponse.setPostCount(postRepository.countPost(email));
        statisticsResponse.setLikesCount(votesRepository.countVotes(true,email));
        statisticsResponse.setDislikeCount(votesRepository.countVotes(false,email));
        statisticsResponse.setFirstPublication(postRepository.getFirstPost(email).getTime());
        statisticsResponse.setViewCount(postRepository.countViews(email));
        return statisticsResponse;
    }
